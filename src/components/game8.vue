<template>
  <div class="game-bg">
    <div class="info-section">
      <div class="roll-item roll-item-8">
        <game-item :isStop='isStopArr[item]' v-for="(item,index) in tempList" :key="item.index"  class="item">{{isStopArr[item]}}</game-item>
      </div>
    </div>
    <div>
...
.game-bg {
  ...
  height: 704px;
  position: relative;
  background:url(../assets/sources/game8bg.jpg)
}
.roll-item {
  /* width: 100px; */
  display: flex;
